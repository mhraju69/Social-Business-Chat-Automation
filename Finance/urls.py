...
urlpatterns = [
    ...
    path('create-checkout/<str:method>/<int:company_id>/', create_checkout_session, name='create_checkout'),
    path('create-checkout/<str:method>/<int:company_id>/<int:plan_id>/', create_checkout_session, name='create_checkout_plan'),
